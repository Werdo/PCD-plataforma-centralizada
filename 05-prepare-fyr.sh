...
# Script: 05-prepare-fyr.sh
# Descomprime, instala y empaqueta la plantilla FYR en Docker

set -e

ZIP_PATH="/home/ppelaez/scripts/fyr/fyr.zip"
TMP_DIR="/home/ppelaez/scripts/tmp-fyr"
TARGET_DIR="/home/ppelaez/plataforma-centralizada/frontend/app"
IMAGE_NAME="frontend-fyr:latest"
...
echo "📦 [3/8] Descomprimiendo plantilla FYR..."
...
npm install --save ajv@8.11.0 ajv-keywords@5.1.0
...
echo "✅ [8/8] Imagen Docker 'frontend-fyr:latest' lista."
